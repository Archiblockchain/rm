...
async function main() {
	try {
		...
		try {
			...
			// result = await contract.submitTransaction('CreateAsset', 'asset3', newasset );
			// console.log('*** Result: committed');
			// if (`${result}` !== '') {
			// 	console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			// }
//-------------------------------------------------------------------------------------------
			console.log('\n--> Submit Transaction: CreateAssetOption2, creates new asset with ID, newasset');
			result = await contract.submitTransaction('CreateAssetOption2', 'asset4');
			console.log('*** Result: committed');
			if (`${result}` !== '') {
				console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			}
			...
			console.log('\n--> Submit Transaction: CreateAsset, by passing the json input');
			result = await contract.submitTransaction('CreateAsset', 'asset5', newasset );
			console.log('*** Result: committed');
			if (`${result}` !== '') {
				console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			}
